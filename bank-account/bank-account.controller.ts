...
export class BankAccountController {
  ...
  @Post()
  createBankAccount(@Body() createBankAccountDto: CreateBankAccountDto, @Req() req: any) {
    return this.bankAccountService.createBankAccount(createBankAccountDto, req.user.id);
  }
  ...
  updateBankAccountById(
    ...
    return this.bankAccountService.updateBankAccountById(bankAccountId, updateBankAccountDto);
  }
