...
import type { UserAddressDetails, UserEmergencyContact } from '../profile.constants';
...
export class User {
    ...
    @Prop({ required: true, unique: true, index: true, sparse: true, uppercase: true, trim: true })
    specialIndex: string;
    ...
    @Prop({ type: String, enum: SalaryCycle, default: SalaryCycle.MONTHLY, index: true })
